...
a1 = read(prefix1+'longMaze-randNoise-seed4/Returns_seed4.csv')
b1 = read(prefix1+'longMaze-randNoise-seed9/Returns_seed9.csv')
c1 = read(prefix1+'longMaze-randNoise-seed15/Returns_seed15.csv')
...
plt.savefig("longMazeCorrelatedNoise.png")
