...
a1 = read(prefix1+'4WayComplex-Test-CorrelatedNoise-seed4/Returns_seed4.csv')
b1 = read(prefix1+'4WayComplex-Test-CorrelatedNoise-seed9/Returns_seed9.csv')
c1 = read(prefix1+'4WayComplex-Test-CorrelatedNoise-seed15/Returns_seed15.csv')
...
successRate = int((100*hits)/(4*7))

plt.title("Success Rate : " + str(successRate)+ " percent")


ax = sns.heatmap(composite, cmap="YlGnBu")
plt.savefig("4wayComplex_addedNoise.png")
