...
a1 = read(prefix2+'4WayComplex-Test-plain-seed4/Returns_seed4.csv')
b1 = read(prefix2+'4WayComplex-Test-plain-seed9/Returns_seed9.csv')
c1 = read(prefix2+'4WayComplex-Test-plain-seed15/Returns_seed15.csv')
...
plt.savefig("4wayComplex_plain.png")
