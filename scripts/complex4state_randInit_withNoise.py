...
prefix = "/home/russellm/rllab/data/local/4WayComplex-Test-CorNoise-INIT-seed"
...
for itr in range(num_itrs):
    ...
    plt.savefig("complex4state_rand_withNoise/itr_"+str(itr)+".png")
    plt.clf()
    


fobj = open("complex4state_rand_withNoise.csv", "wb")
